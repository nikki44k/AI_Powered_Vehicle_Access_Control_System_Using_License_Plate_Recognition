...
Author: Nikhitha | Course: CS 455 Spring 2025 | Date: May 2025
...
Clone or copy this repository and navigate to its root: cd project455

Extract the Kaggle dataset ZIP into data/kaggle/ so you have:
data/kaggle/images/ containing .jpg/.png images
data/kaggle/labels/ containing matching YOLO .txt files
...
Install Tesseract OCR engine on your system and ensure it’s on your PATH (or set pytesseract.pytesseract.tesseract_cmd in code to its exe path).
...
4. Notebooks
    ...
    2) YOLOv8 Training & OCR Integration - notebooks/2_yolov8_training_ocr_integration.ipynb
        ...
        Trains a YOLOv8 model (yolov8n.pt base) and saves weights to model/yolov8_license_plate_model.pt.
...
6. Sources
    ...
    Model Framework: YOLOv8 by Ultralytics (https://ultralytics.com/).
    OCR Engine: Tesseract OCR by Google (https://github.com/tesseract-ocr/tesseract).
    Visualization & UI: Streamlit (https://streamlit.io/).
